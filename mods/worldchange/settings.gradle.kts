// =====================================================================
// mods/worldchange/settings.gradle.kts (Stonecutter included build)
// ---------------------------------------------------------------------
//   この Mod 単体を Stonecutter + loom-back-compat で多版ビルドする
//   自己完結ビルド。 ルートの mod-agnostic 基盤からは includeBuild される。
//
//   版ノードは mc-meta/versions.json を正本として登録する (全 6 ノード)。
//   VisualizeGate / OmniChest と同型: 26.1.x (非難読化・Java25) + 1.21.x (Mojmap・Java21)。
// =====================================================================
...
stonecutter {
    create(rootProject) {
        ...
        vcsVersion = "26.1.2"   // policy.default と一致 (active base = 一方向置換の生成元)
    }
}

rootProject.name = "worldchange"
