...
public final class RenderConfig {
     ...
     *
     * <p>
     * この欄は<b>アイテム名でチェスト内を絞り込む</b> (= 一致しないスロットを暗くする)。
     * 判定は表示名の部分一致で、 空白区切りの複数語は AND (全角スペースも区切り)。
     * ツールチップ {@code omnichest.editbox.search.tooltip} の記述どおりの挙動である
     * (1.21.11 移行時に配線と描画が消えていたのを復旧済)。 このトグルは<b>欄の表示有無だけ</b>
     * を制御し、 倉庫検索 ({@code SearchScreen}) / 分類 / 索引 は本設定と無関係に動作する。
     */
